<template>
  <header class="sticky top-0 left-0 right-0 z-30 bg-white">
    <nav class="flex items-center justify-between flex-wrap bg-teal-500 p-6">
      <div class="flex items-center flex-shrink-0 text-white mr-4">
        <EXdriveLogo class="h-8" />
        <span class="font-semibold text-xl tracking-tight">实验老司机</span>
      </div>
      ...
      <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
        <div class="text-sm lg:flex-grow flex justify-start">
          ...
          <a class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-blue-900 mr-4 text-xl" href="https://appkth0y5jh8510.pc.xiaoe-tech.com/page/2794589?navIndex=1">学习中心</a>
          ...
          <a class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 text-green-600 hover:text-green-400 mr-4 text-xl" href="https://work.weixin.qq.com/kfid/kfc9356685d9b1f2b01">微信客服</a>
        </div>
      </div>
    </nav>
  </header>
...
<script>
import EXdriveLogo from '~/assets/images/logo.svg?inline'
